...
//		try {
//			ConferenceEntryBean bean = new ConferenceEntryBean(
//					adao.selectAccountId(email), -1, email);
//			return bean;
//		} catch (NullPointerException | SQLException e) {
//			e.printStackTrace();
//		}
...
//			String email) {
//		GeneralUserAuthrities authority;
//		try {
//			authority = cedao.affirmConferenceAuthority(conferenceId, email);
//			//講演者の場合、
//			if(authority==GeneralUserAuthrities.PRESENTER){
//				if(cedao.affirmEnterablePresenter(conferenceId, email)){
//					//追加条件１　参加状態と論理削除が両方TRUEで講演者参加がtrueのときは講演者の権限
//					authority = GeneralUserAuthrities.PRESENTER;
//				}else{
//					//追加条件２　参加状態と論理削除が両方TRUEで講演者参加がfalseのときは聴講者の権限
//					authority = GeneralUserAuthrities.AUDITOR;
//				}
//			}
//			return authority;
//		} catch (NullPointerException | SQLException e) {
